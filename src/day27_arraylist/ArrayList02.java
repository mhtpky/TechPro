...
public class ArrayList02 {
	...
	public static void main(String[] args) {
		...
		// SET >> Istenen index'de ki elemani kaldirip,yerine bizim istedigimiz elemani koyar(replace yapar)
		list.set(2, "Kemal");
		...
		//list.set(4, "Mustafa"); olmayan bir index kullanilirsa RTE dondurur
