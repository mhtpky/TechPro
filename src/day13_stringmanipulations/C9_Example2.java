...
public class C9_Example2 {
	...
	public static void main(String[] args) {
		...
		// Ancak primitive data tipleri methoda sahip olmadiklarindan
		// Wrapper class kullanmam lazim
		double sayi1 = Double.parseDouble(str1); //String degeri double 'a cevirmis olduk
